...
bracketedAttrs = _ openBracket attrs:(bracketedAttr / commentWithSpace / blankLine)* closeBracket _ {
  // Filter out comments
...
*/
mustacheKeyValue = _ key:key '=' value:(subexpression / mustacheAttrValue) _ {
  return key + '=' + value;
}
