...
inHtmlTag
= h:htmlStart startingInTagMustaches:inTagMustache* blockParams:blockParams? __ openBracket modifiers:bracketedModifier* fullAttributes:(bracketedAttribute / commentWithSpace / blankLine)* &closeBracket
{
  // Filter out comments
