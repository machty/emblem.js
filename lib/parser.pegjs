...
{
  return createBlockOrMustache(mustache, true);
}
...
{
  return createBlockOrMustache(mustacheTuple, e);
}
...
rawMustacheSingle
 = singleOpen _ m:recursivelyParsedMustacheContent _ singleClose { throw new Error('unimplemented'); m.escaped = true; return m; }
inTagMustache
