@import "./attrs.pegjs" as mustacheAttrs
...
newMustache = name:newMustacheStart _ attrs:mustacheAttrs blockParams:blockParams? {
...
newMustacheName = !invalidNameStartChar name:$newMustacheNameChar+ modifier:modifierChar? {
  return {
    name: name,
    modifier: modifier
  };
