...
var CompilerContext, EmberHandlebars, Emblem, Handlebars, assert, bindAttrHelper, compileWithPartials, equal, equals, ok, runTextLineSuite, shouldCompileTo, shouldCompileToString, shouldCompileToWithPartials, shouldEmberPrecompileToHelper, shouldThrow, throws, _equal,
...
shouldEmberPrecompileToHelper = function(emblem, helper) {
  ...
  return ok(Emblem.precompile(EmberHandlebars, emblem).toString().match("helpers." + helper));
};
