...
Emblem.Parser = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c26 = function(mustacheNode, t) {
          var programNode = new AST.ProgramNode(t, []);
          return new AST.BlockNode(mustacheNode, programNode, programNode.inverse, mustacheNode.id);
        },
        peg$c27 = function(e, ret) {
          var mustache = ret.mustache || ret;
          mustache.escaped = e;
          return ret;
        },
        peg$c28 = function(path, tm, params, hash) { 
          var actualParams = [];
          var attrs = {};
          var hasAttrs = false;
        ...
        peg$c29 = function(p, m) { 
          var ret = new String(p);
          ret.trailingModifier = m;
          return ret;
        },
        peg$c30 = function(t) { return ['tagName', t]; },
        peg$c31 = function(i) { return ['elementId', i]; },
        peg$c32 = function(c) { return ['class', c]; },
        peg$c33 = function(id, classes) { return [id, classes]; },
        peg$c34 = function(classes) { return [null, classes]; },
        peg$c35 = function(h) { return h; },
        peg$c36 = "TrailingModifier",
        peg$c37 = /^[!?*\^]/,
        peg$c38 = "[!?*\\^]",
        peg$c39 = function(h) { return new AST.HashNode(h); },
        peg$c40 = "PathIdent",
        peg$c41 = "..",
        peg$c42 = "\"..\"",
        peg$c43 = ".",
        ...
        peg$c50 = "Key",
        peg$c51 = function(h) { return [h[0], h[2]]; },
        peg$c52 = function(p) { return p; },
        peg$c53 = function(first, tail) {
          var ret = [first];
        ...
        peg$c54 = "PathSeparator",
        peg$c55 = /^[\/.]/,
        peg$c56 = "[\\/.]",
        peg$c57 = function(v) { return new AST.IdNode(v); },
        peg$c58 = function(v) { return new AST.StringNode(v); },
        peg$c59 = function(v) { return new AST.IntegerNode(v); },
        peg$c60 = function(v) { return new AST.BooleanNode(v); },
        peg$c61 = "Boolean",
        peg$c62 = "true",
        peg$c63 = "\"true\"",
        peg$c64 = "false",
        ...
        peg$c67 = /^[0-9]/,
        peg$c68 = "[0-9]",
        peg$c69 = function(s) { return parseInt(s); },
        peg$c70 = "\"",
        peg$c71 = "\"\\\"\"",
        peg$c72 = "'",
        peg$c73 = "\"'\"",
        peg$c74 = function(p) { return p[1]; },
        peg$c75 = /^[^"}]/,
        peg$c76 = "[^\"}]",
        peg$c77 = /^[^'}]/,
        peg$c78 = "[^'}]",
        peg$c79 = /^[A-Za-z]/,
        peg$c80 = "[A-Za-z]",
        peg$c81 = function(m) { return [m]; },
        peg$c82 = /^[|`]/,
        peg$c83 = "[|`]",
        peg$c84 = "<",
        peg$c85 = "\"<\"",
        peg$c86 = function() { return '<'; },
        peg$c87 = function(s, nodes, indentedNodes) { 
          if(indentedNodes) {
        ...
        peg$c91 = function(a) { return new AST.ContentNode(a.join('')); },
        ...
        peg$c124 = /^[A-Za-z.:0-9]/,
        peg$c125 = "[A-Za-z.:0-9]",
        peg$c126 = function(id) { return new AST.MustacheNode([id]); },
        ...
        peg$c139 = "CSSIdentifier",
        peg$c140 = function(nmstart, nmchars) { return nmstart + nmchars; },
        peg$c141 = /^[_a-zA-Z0-9\-]/,
        peg$c142 = "[_a-zA-Z0-9\\-]",
        peg$c143 = /^[_a-zA-Z]/,
        peg$c144 = "[_a-zA-Z]",
        peg$c145 = /^[\x80-\xFF]/,
        peg$c146 = "[\\x80-\\xFF]",
        peg$c147 = "KnownHTMLTagName",
        peg$c148 = function(t) { return !!KNOWN_TAGS[t]; },
        peg$c149 = function(t) { return t; },
        peg$c150 = /^[:_a-zA-Z0-9\-]/,
        peg$c151 = "[:_a-zA-Z0-9\\-]",
        peg$c152 = "a JS event",
        peg$c153 = function(t) { return !!KNOWN_EVENTS[t]; },
        peg$c154 = "INDENT",
        peg$c155 = "\uEFEF",
        peg$c156 = "\"\\uEFEF\"",
        ...
        peg$c164 = "\uEFFF",
        peg$c165 = "\"\\uEFFF\"",
        peg$c166 = "RequiredWhitespace",
        peg$c167 = "OptionalWhitespace",
        peg$c168 = "InlineWhitespace",
        peg$c169 = /^[ \t]/,
        peg$c170 = "[ \\t]",
