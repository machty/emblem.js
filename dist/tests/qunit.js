...
(function (window) {
  ...
  var synchronize = function (callback, last) {
   ...
   * @param {Function} fn
   */
  var addEvents = function (elems, type, fn) {
    var i = elems.length;
    while (i--) {
  ...
  var registerLoggingCallback = function (key) {
  ...
  var runLoggingCallbacks = function (key, scope, args) {
    var i, callbacks;
  ...
  QUnit.equiv = (function () {
    ...
    var bindCallbacks = function (o, callbacks, args) {
  ...
  QUnit.jsDump = (function () {
    ...
    var literal = function (o) {
      return o + "";
    };

    var join = function (pre, arr, post) {
