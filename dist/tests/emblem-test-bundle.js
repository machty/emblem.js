...
test('parser-delegate/ember.js should pass jshint', function() { 
  ok(false, 'parser-delegate/ember.js should pass jshint.\nparser-delegate/ember.js: line 14, col 32, The \'__proto__\' property is deprecated.\n\n1 error'); 
});
...
(function() {
    ...
    var $$parser$$Parser = (function() {
      ...
      function parse(input) {
        var options = arguments.length > 1 ? arguments[1] : {},
            ...
            peg$c38 = function(statements) { return astDelegate.createProgramNode(statements, []); },
            peg$c39 = function(block) {return block && block[2]; },
            ...
            peg$c47 = function(path, params, hash) { return parseSexpr(path, params, hash); },
            ...
            peg$c52 = function(id, classes) { return [id, classes]; },
            peg$c53 = function(classes) { return [null, classes]; },
            peg$c54 = function(p) { return p; },
            peg$c55 = function(a) { return a; },
            peg$c56 = function(h) { return new AST.HashNode(h); },
            ...
            peg$c67 = function(segmentLiteral) { return segmentLiteral; },
            peg$c68 = { type: "other", description: "Key" },
            peg$c69 = ":",
            peg$c70 = { type: "literal", value: ":", description: "\":\"" },
            peg$c71 = function(h) { return [h[0], h[2]]; },
            peg$c72 = function(h) { return [h[0], h[2]];},
            peg$c73 = function(s) { s.isHelper = true; return s; },
            peg$c74 = function(s, p) { return { part: p, separator: s }; },
            ...
            peg$c80 = function(v) { return new AST.StringNode(v); },
            peg$c81 = function(v) { return new AST.NumberNode(v); },
            peg$c82 = function(v) { return new AST.BooleanNode(v); },
            ...
            peg$c93 = function(s) { return parseInt(s); },
            peg$c94 = "\"",
            peg$c95 = { type: "literal", value: "\"", description: "\"\\\"\"" },
            peg$c96 = "'",
            peg$c97 = { type: "literal", value: "'", description: "\"'\"" },
            peg$c98 = function(p) { return p[1]; },
            peg$c99 = /^[^"}]/,
            ...
            peg$c113 = function(first, tail) { return textNodesResult(first, tail); },
            peg$c114 = "{",
            ...
            peg$c119 = function(m) { m.escaped = true; return m; },
            peg$c120 = function(m) { m.escaped = false; return m; },
            peg$c121 = function(a) { return new AST.ContentNode(a); },
            ...
            peg$c153 = function(h, s) { return h || s; },
            peg$c154 = function(h, inTagMustaches, fullAttributes) { 
              return parseInHtml(h, inTagMustaches, fullAttributes);
            },
            peg$c155 = function(s) { return { shorthand: s, id: true}; },
            peg$c156 = function(s) { return { shorthand: s }; },
            ...
            peg$c161 = function(id) { return astDelegate.createMustacheNode([id], null, true); },
            ...
            peg$c164 = function(value) { return value.replace(/ *$/, ''); },
            peg$c165 = "!",
            peg$c166 = { type: "literal", value: "!", description: "\"!\"" },
            peg$c167 = function(key, value) { return astDelegate.allowBoundAttributes; },
            ...
            peg$c186 = function(t) { return !!KNOWN_TAGS[t]; },
            peg$c187 = function(t) { return t; },
            peg$c188 = { type: "other", description: "a JS event" },
            peg$c189 = function(t) { return !!KNOWN_EVENTS[t]; },
    ...
    var $$parser$$parse = $$parser$$Parser.parse, $$parser$$ParserSyntaxError = $$parser$$Parser.SyntaxError;
    var $$parser$$default = $$parser$$parse;
    var $$parser$delegate$base$$$__Object$defineProperties = Object.defineProperties;
    var $$parser$delegate$base$$$__Object$getPrototypeOf = Object.getPrototypeOf;

    var $$parser$delegate$base$$ParserDelegate = function() {
      "use strict";

      function ParserDelegate(AST, parse) {
        $$parser$delegate$base$$$__Object$getPrototypeOf(ParserDelegate.prototype).constructor.call(this, AST, parse);
      }

      $$parser$delegate$base$$$__Object$defineProperties(ParserDelegate.prototype, {
    ...
    var $$parser$delegate$ember$$$__Object$defineProperties = Object.defineProperties;
    var $$parser$delegate$ember$$$__Object$defineProperty = Object.defineProperty;
    var $$parser$delegate$ember$$$__Object$create = Object.create;

    var $$parser$delegate$ember$$EmberParserDelegate = function($__super) {
      "use strict";
      ...
      EmberParserDelegate.prototype = $$parser$delegate$ember$$$__Object$create(($__super !== null ? $__super.prototype : null));

      $$parser$delegate$ember$$$__Object$defineProperty(EmberParserDelegate.prototype, "constructor", {
        value: EmberParserDelegate
      });

      $$parser$delegate$ember$$$__Object$defineProperties(EmberParserDelegate.prototype, {
        handleCapitalizedMustache: {
          value: function(mustache) {
    ...
    function $$compiler$$throwCompileError(line, msg) {
      throw new Error("Emblem syntax error, line " + line + ": " + msg);
    }

    function $$compiler$$registerPartial(handlebarsVariant, partialName, text) {
      if (!text) {
        text = partialName;
    ...
    function $$compiler$$parse(string) {
    ...
    function $$compiler$$precompile(handlebarsVariant, string, options) {
      var ast;
      if (options == null) {
        options = {};
      }
    ...
    function $$compiler$$compile(handlebarsVariant, string, options) {
      var ast;
      if (options == null) {
        options = {};
      }
    ...
    function $$bootstrap$$compileScriptTags(scope) {
